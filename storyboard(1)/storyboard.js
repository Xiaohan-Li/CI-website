...
document.addEventListener('DOMContentLoaded',function () {
 ...
 <div `+`class= cy${index}`+` style='height:100%; width:868px; display:block; border-style:solid; border-width:1px; border-color:hsl(280,53%,60%); background-color:hsl(280,53%,98%); box-shadow: rgb(222,160,248) 0 0 1px 1px;);'></div>
</div>`
